...
const QuickActionsSection: React.FC = () => {
  const quickActions = [
    {
      icon: (
        <svg className="w-5 h-5 text-electric-blue dark:text-electric-cyan" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd"></path>
        </svg>
      ),
      label: 'Create new task',
      href: '/projects/tasks',
      color: 'text-electric-blue dark:text-electric-cyan'
    },
    {
      icon: (
        <svg className="w-5 h-5 text-electric-green dark:text-electric-green" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      href: '/knowledge',
      color: 'text-electric-green dark:text-electric-green'
    },
    {
      icon: (
        <svg className="w-5 h-5 text-electric-purple dark:text-electric-purple" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path>
        </svg>
      ),
      label: 'Schedule event',
      href: '/schedule/calendar',
      color: 'text-electric-purple dark:text-electric-purple'
    },
    {
      icon: (
        <svg className="w-5 h-5 text-electric-yellow dark:text-electric-orange" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      color: 'text-electric-yellow dark:text-electric-orange'
    },
    {
      icon: (
        <svg className="w-5 h-5 text-electric-pink dark:text-electric-pink" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
        </svg>
      ),
      label: 'Add team member',
      href: '/staff/directory',
      color: 'text-electric-pink dark:text-electric-pink'
    },
    {
      icon: (
        <svg className="w-5 h-5 text-electric-blue dark:text-electric-cyan" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-electric-blue dark:text-electric-cyan font-medium">Aug 2</span>
          </div>
        </div>
        <div className="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-700">
          <button className="text-sm text-electric-cyan dark:text-electric-blue hover:underline w-full text-center">
            Set new reminder
          </button>
        </div>
      </div>
      ...
      <div className="card bg-gradient-to-br from-electric-cyan/20 to-electric-blue/10 dark:from-electric-blue/20 dark:to-electric-cyan/10 border-electric-cyan/30 dark:border-electric-blue/30">
        ...
        <div className="mt-4 pt-4 border-t border-neutral-200 dark:border-neutral-700">
          <a href="/finance/bank" className="text-sm text-electric-cyan dark:text-electric-blue hover:underline block text-center">
            View transactions →
          </a>
        </div>
      </div>
